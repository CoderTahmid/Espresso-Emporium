...
const UpdateCoffee = () => {
	...
	const handleUpdateCoffee = (event) => {
		...
		fetch(`https://espresso-emporium-server-rho-ten.vercel.app/coffee/${_id}`, {
			method: "PUT",
			headers: {
	...
	return (
		<div className="bg-[#F4F3F0] p-24">
			...
			<form className="space-y-9" onSubmit={handleUpdateCoffee}>
				...
				<div className="md:flex gap-10">
					...
					<div className="form-control md:w-1/2">
						...
						<label className="input-group">
							<input type="text" name="details" defaultValue={photo} placeholder="Details" className="input input-bordered w-full" />
						</label>
					</div>
				</div>
